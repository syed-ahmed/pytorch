...
size_t MSNPUType::elementSizeInBytes() const {
  AT_ERROR("elementSizeInBytes is not implemented for MSNPUType");
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::_th_kthvalue_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t k, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, int64_t, int64_t, bool)>("_th_kthvalue_out(Tensor values, IndexTensor indices, Tensor self, int64_t k, int64_t dim, bool keepdim) -> std::tuple<Tensor &,Tensor &>")(values, indices, self, k, dim, keepdim);
}
std::tuple<Tensor,Tensor> MSNPUType::_th_kthvalue(const Tensor & self, int64_t k, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, int64_t, bool)>("_th_kthvalue(Tensor self, int64_t k, int64_t dim, bool keepdim) -> std::tuple<Tensor,Tensor>")(self, k, dim, keepdim);
}
...
Tensor MSNPUType::_th_median(const Tensor & self) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &)>("_th_median(Tensor self) -> Tensor")(self);
}
std::tuple<Tensor &,Tensor &> MSNPUType::_th_median_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, int64_t, bool)>("_th_median_out(Tensor values, IndexTensor indices, Tensor self, int64_t dim, bool keepdim) -> std::tuple<Tensor &,Tensor &>")(values, indices, self, dim, keepdim);
}
std::tuple<Tensor,Tensor> MSNPUType::_th_median(const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, bool)>("_th_median(Tensor self, int64_t dim, bool keepdim) -> std::tuple<Tensor,Tensor>")(self, dim, keepdim);
}
...
Tensor & MSNPUType::s__th_lerp_out(Tensor & result, const Tensor & self, const Tensor & end, Scalar weight) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, Scalar)>("_th_lerp_out(Tensor result, Tensor self, Tensor end, real weight) -> Tensor")(result, self, end, weight);
}
Tensor MSNPUType::s__th_lerp(const Tensor & self, const Tensor & end, Scalar weight) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, Scalar)>("_th_lerp(Tensor self, Tensor end, real weight) -> Tensor")(self, end, weight);
}
Tensor & MSNPUType::s__th_lerp_(Tensor & self, const Tensor & end, Scalar weight) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, Scalar)>("_th_lerp_(Tensor self, Tensor end, real weight) -> Tensor")(self, end, weight);
}
...
Tensor & MSNPUType::_th_cross_out(Tensor & result, const Tensor & self, const Tensor & other, int64_t dim) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, int64_t)>("_th_cross_out(Tensor result, Tensor self, Tensor other, int64_t dim) -> Tensor")(result, self, other, dim);
}
Tensor MSNPUType::_th_cross(const Tensor & self, const Tensor & other, int64_t dim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, int64_t)>("_th_cross(Tensor self, Tensor other, int64_t dim) -> Tensor")(self, other, dim);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::_th_trtrs_out(Tensor & res1, Tensor & res2, const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &, bool, bool, bool)>("_th_trtrs_out(Tensor res1, Tensor res2, Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor &,Tensor &>")(res1, res2, self, A, upper, transpose, unitriangular);
}
std::tuple<Tensor,Tensor> MSNPUType::_th_trtrs(const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &, bool, bool, bool)>("_th_trtrs(Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor,Tensor>")(self, A, upper, transpose, unitriangular);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::_th_btrifact_out(Tensor & result, Tensor & pivots, const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, bool)>("_th_btrifact_out(Tensor result, IntegerTensor pivots, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &>")(result, pivots, self, pivot);
}
std::tuple<Tensor,Tensor> MSNPUType::_th_btrifact(const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, bool)>("_th_btrifact(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor>")(self, pivot);
}
std::tuple<Tensor &,Tensor &,Tensor &> MSNPUType::_th_btrifact_with_info_out(Tensor & result, Tensor & pivots, Tensor & info, const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &,Tensor &> (*)(Tensor &, Tensor &, Tensor &, const Tensor &, bool)>("_th_btrifact_with_info_out(Tensor result, IntegerTensor pivots, IntegerTensor info, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &,Tensor &>")(result, pivots, info, self, pivot);
}
std::tuple<Tensor,Tensor,Tensor> MSNPUType::_th_btrifact_with_info(const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor,Tensor> (*)(const Tensor &, bool)>("_th_btrifact_with_info(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor,Tensor>")(self, pivot);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::_thnn_adaptive_max_pool2d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool2d_forward_out(Tensor output, IndexTensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
std::tuple<Tensor,Tensor> MSNPUType::_thnn_adaptive_max_pool2d_forward(const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool2d_forward(Tensor self, IntArrayRef output_size) -> std::tuple<Tensor,Tensor>")(self, output_size);
}
Tensor & MSNPUType::_thnn_adaptive_max_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool2d_backward_out(Tensor grad_input, Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_input, grad_output, self, indices);
}
Tensor MSNPUType::_thnn_adaptive_max_pool2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool2d_backward(Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_output, self, indices);
}
std::tuple<Tensor &,Tensor &> MSNPUType::_thnn_adaptive_max_pool3d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool3d_forward_out(Tensor output, IndexTensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
std::tuple<Tensor,Tensor> MSNPUType::_thnn_adaptive_max_pool3d_forward(const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool3d_forward(Tensor self, IntArrayRef output_size) -> std::tuple<Tensor,Tensor>")(self, output_size);
}
Tensor & MSNPUType::_thnn_adaptive_max_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool3d_backward_out(Tensor grad_input, Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_input, grad_output, self, indices);
}
Tensor MSNPUType::_thnn_adaptive_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool3d_backward(Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_output, self, indices);
}
...
std::tuple<Tensor,Tensor,Tensor,std::vector<Tensor>> MSNPUType::_cudnn_rnn_backward(const Tensor & input, TensorList weight, int64_t weight_stride0, const Tensor & weight_buf, const Tensor & hx, const Tensor & cx, const Tensor & output, const Tensor & grad_output, const Tensor & grad_hy, const Tensor & grad_cy, int64_t mode, int64_t hidden_size, int64_t num_layers, bool batch_first, double dropout, bool train, bool bidirectional, IntArrayRef batch_sizes, const Tensor & dropout_state, const Tensor & reserve, std::array<bool,4> output_mask) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor,Tensor,std::vector<Tensor>> (*)(const Tensor &, TensorList, int64_t, const Tensor &, const Tensor &, const Tensor &, const Tensor &, const Tensor &, const Tensor &, const Tensor &, int64_t, int64_t, int64_t, bool, double, bool, bool, IntArrayRef, const Tensor &, const Tensor &, std::array<bool,4>)>("_cudnn_rnn_backward(Tensor input, TensorList weight, int64_t weight_stride0, Tensor weight_buf, Tensor hx, Tensor cx, Tensor output, Tensor grad_output, Tensor grad_hy, Tensor grad_cy, int64_t mode, int64_t hidden_size, int64_t num_layers, bool batch_first, double dropout, bool train, bool bidirectional, IntArrayRef batch_sizes, BoolTensor dropout_state, Tensor reserve, std::array<bool,4> output_mask) -> std::tuple<Tensor,Tensor,Tensor,std::vector<Tensor>>")(input, weight, weight_stride0, weight_buf, hx, cx, output, grad_output, grad_hy, grad_cy, mode, hidden_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state, reserve, output_mask);
}
...
Tensor MSNPUType::argmax(const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("argmax(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor MSNPUType::argmax(const Tensor & self) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &)>("argmax(Tensor self) -> Tensor")(self);
}
Tensor MSNPUType::_argmax(const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("_argmax(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor MSNPUType::argmin(const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("argmin(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor MSNPUType::argmin(const Tensor & self) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &)>("argmin(Tensor self) -> Tensor")(self);
}
Tensor MSNPUType::_argmin(const Tensor & self, int64_t dim, bool keepdim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("_argmin(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
...
std::tuple<Tensor,Tensor> MSNPUType::gesv(const Tensor & self, const Tensor & A) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &)>("gesv(Tensor self, Tensor A) -> std::tuple<Tensor,Tensor>")(self, A);
}
std::tuple<Tensor &,Tensor &> MSNPUType::gesv_out(Tensor & solution, Tensor & lu, const Tensor & self, const Tensor & A) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &)>("gesv_out(Tensor solution, Tensor lu, Tensor self, Tensor A) -> std::tuple<Tensor &,Tensor &>")(solution, lu, self, A);
}
std::tuple<Tensor,Tensor> MSNPUType::_gesv_helper(const Tensor & self, const Tensor & A) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &)>("_gesv_helper(Tensor self, Tensor A) -> std::tuple<Tensor,Tensor>")(self, A);
}
...
int64_t MSNPUType::_cufft_get_plan_cache_size() const {
    return MSNPUTypeDispatch::get_function<int64_t (*)()>("_cufft_get_plan_cache_size() -> int64_t")();
}
int64_t MSNPUType::_cufft_get_plan_cache_max_size() const {
    return MSNPUTypeDispatch::get_function<int64_t (*)()>("_cufft_get_plan_cache_max_size() -> int64_t")();
}
void MSNPUType::_cufft_set_plan_cache_max_size(int64_t max_size) const {
    return MSNPUTypeDispatch::get_function<void (*)(int64_t)>("_cufft_set_plan_cache_max_size(int64_t max_size) -> void")(max_size);
}
void MSNPUType::_cufft_clear_plan_cache() const {
    return MSNPUTypeDispatch::get_function<void (*)()>("_cufft_clear_plan_cache() -> void")();
}
...
Tensor MSNPUType::logspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(Scalar, Scalar, int64_t, const TensorOptions &)>("logspace(Scalar start, Scalar end, int64_t steps, TensorOptions options) -> Tensor")(start, end, steps, options);
}
Tensor & MSNPUType::logspace_out(Tensor & out, Scalar start, Scalar end, int64_t steps) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, Scalar, Scalar, int64_t)>("logspace_out(Tensor out, Scalar start, Scalar end, int64_t steps) -> Tensor")(out, start, end, steps);
}
...
Tensor MSNPUType::one_hot(const Tensor & self, int64_t num_classes) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t)>("one_hot(IndexTensor self, int64_t num_classes) -> Tensor")(self, num_classes);
}
...
std::tuple<Tensor,Tensor> MSNPUType::_unique_dim(const Tensor & self, int64_t dim, bool sorted, bool return_inverse) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, bool, bool)>("_unique_dim(Tensor self, int64_t dim, bool sorted, bool return_inverse) -> std::tuple<Tensor,Tensor>")(self, dim, sorted, return_inverse);
}
...
Tensor MSNPUType::native_clone(const Tensor & self) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &)>("native_clone(Tensor self) -> Tensor")(self);
}
...
Tensor & MSNPUType::native_resize_as_(Tensor & self, const Tensor & the_template) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &)>("native_resize_as_(Tensor self, Tensor the_template) -> Tensor")(self, the_template);
}
...
Tensor & MSNPUType::native_pow_out(Tensor & out, const Tensor & self, Scalar exponent) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, Scalar)>("native_pow_out(Tensor out, Tensor self, Scalar exponent) -> Tensor")(out, self, exponent);
}
Tensor MSNPUType::native_pow(const Tensor & self, Scalar exponent) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, Scalar)>("native_pow(Tensor self, Scalar exponent) -> Tensor")(self, exponent);
}
...
Tensor & MSNPUType::native_zero_(Tensor & self) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &)>("native_zero_(Tensor self) -> Tensor")(self);
}
...
Tensor & MSNPUType::cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, int64_t)>("cross_out(Tensor out, Tensor self, Tensor other, int64_t dim) -> Tensor")(out, self, other, dim);
}
Tensor MSNPUType::cross(const Tensor & self, const Tensor & other, int64_t dim) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, int64_t)>("cross(Tensor self, Tensor other, int64_t dim) -> Tensor")(self, other, dim);
}
...
Tensor & MSNPUType::gather_out(Tensor & out, const Tensor & self, int64_t dim, const Tensor & index) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, int64_t, const Tensor &)>("gather_out(Tensor out, Tensor self, int64_t dim, Tensor index) -> Tensor")(out, self, dim, index);
}
Tensor MSNPUType::gather(const Tensor & self, int64_t dim, const Tensor & index) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, const Tensor &)>("gather(Tensor self, int64_t dim, Tensor index) -> Tensor")(self, dim, index);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::trtrs_out(Tensor & X, Tensor & M, const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &, bool, bool, bool)>("trtrs_out(Tensor X, Tensor M, Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor &,Tensor &>")(X, M, self, A, upper, transpose, unitriangular);
}
std::tuple<Tensor,Tensor> MSNPUType::trtrs(const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &, bool, bool, bool)>("trtrs(Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor,Tensor>")(self, A, upper, transpose, unitriangular);
}
...
Tensor & MSNPUType::potri_out(Tensor & out, const Tensor & self, bool upper) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, bool)>("potri_out(Tensor out, Tensor self, bool upper) -> Tensor")(out, self, upper);
}
Tensor MSNPUType::potri(const Tensor & self, bool upper) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, bool)>("potri(Tensor self, bool upper) -> Tensor")(self, upper);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::btrifact_out(Tensor & A_LU, Tensor & pivots, const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, bool)>("btrifact_out(Tensor A_LU, Tensor pivots, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &>")(A_LU, pivots, self, pivot);
}
std::tuple<Tensor,Tensor> MSNPUType::btrifact(const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, bool)>("btrifact(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor>")(self, pivot);
}
std::tuple<Tensor &,Tensor &,Tensor &> MSNPUType::btrifact_with_info_out(Tensor & A_LU, Tensor & pivots, Tensor & info, const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &,Tensor &> (*)(Tensor &, Tensor &, Tensor &, const Tensor &, bool)>("btrifact_with_info_out(Tensor A_LU, Tensor pivots, Tensor info, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &,Tensor &>")(A_LU, pivots, info, self, pivot);
}
std::tuple<Tensor,Tensor,Tensor> MSNPUType::btrifact_with_info(const Tensor & self, bool pivot) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor,Tensor,Tensor> (*)(const Tensor &, bool)>("btrifact_with_info(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor,Tensor>")(self, pivot);
}
Tensor & MSNPUType::btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
    return MSNPUTypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("btrisolve_out(Tensor out, Tensor self, Tensor LU_data, Tensor LU_pivots) -> Tensor")(out, self, LU_data, LU_pivots);
}
Tensor MSNPUType::btrisolve(const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
    return MSNPUTypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("btrisolve(Tensor self, Tensor LU_data, Tensor LU_pivots) -> Tensor")(self, LU_data, LU_pivots);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::adaptive_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("adaptive_max_pool2d_out(Tensor output, Tensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
...
std::tuple<Tensor &,Tensor &> MSNPUType::adaptive_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return MSNPUTypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("adaptive_max_pool3d_out(Tensor output, Tensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
