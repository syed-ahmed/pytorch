...
size_t XLAType::elementSizeInBytes() const {
  AT_ERROR("elementSizeInBytes is not implemented for XLAType");
}
...
std::tuple<Tensor &,Tensor &> XLAType::_th_kthvalue_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t k, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, int64_t, int64_t, bool)>("_th_kthvalue_out(Tensor values, IndexTensor indices, Tensor self, int64_t k, int64_t dim, bool keepdim) -> std::tuple<Tensor &,Tensor &>")(values, indices, self, k, dim, keepdim);
}
std::tuple<Tensor,Tensor> XLAType::_th_kthvalue(const Tensor & self, int64_t k, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, int64_t, bool)>("_th_kthvalue(Tensor self, int64_t k, int64_t dim, bool keepdim) -> std::tuple<Tensor,Tensor>")(self, k, dim, keepdim);
}
...
Tensor XLAType::_th_median(const Tensor & self) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &)>("_th_median(Tensor self) -> Tensor")(self);
}
std::tuple<Tensor &,Tensor &> XLAType::_th_median_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, int64_t, bool)>("_th_median_out(Tensor values, IndexTensor indices, Tensor self, int64_t dim, bool keepdim) -> std::tuple<Tensor &,Tensor &>")(values, indices, self, dim, keepdim);
}
std::tuple<Tensor,Tensor> XLAType::_th_median(const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, bool)>("_th_median(Tensor self, int64_t dim, bool keepdim) -> std::tuple<Tensor,Tensor>")(self, dim, keepdim);
}
...
Tensor & XLAType::s__th_lerp_out(Tensor & result, const Tensor & self, const Tensor & end, Scalar weight) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, Scalar)>("_th_lerp_out(Tensor result, Tensor self, Tensor end, real weight) -> Tensor")(result, self, end, weight);
}
Tensor XLAType::s__th_lerp(const Tensor & self, const Tensor & end, Scalar weight) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, Scalar)>("_th_lerp(Tensor self, Tensor end, real weight) -> Tensor")(self, end, weight);
}
Tensor & XLAType::s__th_lerp_(Tensor & self, const Tensor & end, Scalar weight) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, Scalar)>("_th_lerp_(Tensor self, Tensor end, real weight) -> Tensor")(self, end, weight);
}
...
Tensor & XLAType::_th_cross_out(Tensor & result, const Tensor & self, const Tensor & other, int64_t dim) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, int64_t)>("_th_cross_out(Tensor result, Tensor self, Tensor other, int64_t dim) -> Tensor")(result, self, other, dim);
}
Tensor XLAType::_th_cross(const Tensor & self, const Tensor & other, int64_t dim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, int64_t)>("_th_cross(Tensor self, Tensor other, int64_t dim) -> Tensor")(self, other, dim);
}
...
std::tuple<Tensor &,Tensor &> XLAType::_th_trtrs_out(Tensor & res1, Tensor & res2, const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &, bool, bool, bool)>("_th_trtrs_out(Tensor res1, Tensor res2, Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor &,Tensor &>")(res1, res2, self, A, upper, transpose, unitriangular);
}
std::tuple<Tensor,Tensor> XLAType::_th_trtrs(const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &, bool, bool, bool)>("_th_trtrs(Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor,Tensor>")(self, A, upper, transpose, unitriangular);
}
...
std::tuple<Tensor &,Tensor &> XLAType::_th_btrifact_out(Tensor & result, Tensor & pivots, const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, bool)>("_th_btrifact_out(Tensor result, IntegerTensor pivots, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &>")(result, pivots, self, pivot);
}
std::tuple<Tensor,Tensor> XLAType::_th_btrifact(const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, bool)>("_th_btrifact(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor>")(self, pivot);
}
std::tuple<Tensor &,Tensor &,Tensor &> XLAType::_th_btrifact_with_info_out(Tensor & result, Tensor & pivots, Tensor & info, const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &,Tensor &> (*)(Tensor &, Tensor &, Tensor &, const Tensor &, bool)>("_th_btrifact_with_info_out(Tensor result, IntegerTensor pivots, IntegerTensor info, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &,Tensor &>")(result, pivots, info, self, pivot);
}
std::tuple<Tensor,Tensor,Tensor> XLAType::_th_btrifact_with_info(const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor,Tensor> (*)(const Tensor &, bool)>("_th_btrifact_with_info(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor,Tensor>")(self, pivot);
}
...
std::tuple<Tensor &,Tensor &> XLAType::_thnn_adaptive_max_pool2d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool2d_forward_out(Tensor output, IndexTensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
std::tuple<Tensor,Tensor> XLAType::_thnn_adaptive_max_pool2d_forward(const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool2d_forward(Tensor self, IntArrayRef output_size) -> std::tuple<Tensor,Tensor>")(self, output_size);
}
Tensor & XLAType::_thnn_adaptive_max_pool2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool2d_backward_out(Tensor grad_input, Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_input, grad_output, self, indices);
}
Tensor XLAType::_thnn_adaptive_max_pool2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool2d_backward(Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_output, self, indices);
}
std::tuple<Tensor &,Tensor &> XLAType::_thnn_adaptive_max_pool3d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool3d_forward_out(Tensor output, IndexTensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
std::tuple<Tensor,Tensor> XLAType::_thnn_adaptive_max_pool3d_forward(const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, IntArrayRef)>("_thnn_adaptive_max_pool3d_forward(Tensor self, IntArrayRef output_size) -> std::tuple<Tensor,Tensor>")(self, output_size);
}
Tensor & XLAType::_thnn_adaptive_max_pool3d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool3d_backward_out(Tensor grad_input, Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_input, grad_output, self, indices);
}
Tensor XLAType::_thnn_adaptive_max_pool3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & indices) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("_thnn_adaptive_max_pool3d_backward(Tensor grad_output, Tensor self, IndexTensor indices) -> Tensor")(grad_output, self, indices);
}
...
Tensor XLAType::argmax(const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("argmax(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor XLAType::argmax(const Tensor & self) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &)>("argmax(Tensor self) -> Tensor")(self);
}
Tensor XLAType::_argmax(const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("_argmax(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor XLAType::argmin(const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("argmin(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
Tensor XLAType::argmin(const Tensor & self) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &)>("argmin(Tensor self) -> Tensor")(self);
}
Tensor XLAType::_argmin(const Tensor & self, int64_t dim, bool keepdim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, bool)>("_argmin(Tensor self, int64_t dim, bool keepdim) -> Tensor")(self, dim, keepdim);
}
...
std::tuple<Tensor,Tensor> XLAType::gesv(const Tensor & self, const Tensor & A) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &)>("gesv(Tensor self, Tensor A) -> std::tuple<Tensor,Tensor>")(self, A);
}
std::tuple<Tensor &,Tensor &> XLAType::gesv_out(Tensor & solution, Tensor & lu, const Tensor & self, const Tensor & A) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &)>("gesv_out(Tensor solution, Tensor lu, Tensor self, Tensor A) -> std::tuple<Tensor &,Tensor &>")(solution, lu, self, A);
}
std::tuple<Tensor,Tensor> XLAType::_gesv_helper(const Tensor & self, const Tensor & A) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &)>("_gesv_helper(Tensor self, Tensor A) -> std::tuple<Tensor,Tensor>")(self, A);
}
...
int64_t XLAType::_cufft_get_plan_cache_size() const {
    return XLATypeDispatch::get_function<int64_t (*)()>("_cufft_get_plan_cache_size() -> int64_t")();
}
int64_t XLAType::_cufft_get_plan_cache_max_size() const {
    return XLATypeDispatch::get_function<int64_t (*)()>("_cufft_get_plan_cache_max_size() -> int64_t")();
}
void XLAType::_cufft_set_plan_cache_max_size(int64_t max_size) const {
    return XLATypeDispatch::get_function<void (*)(int64_t)>("_cufft_set_plan_cache_max_size(int64_t max_size) -> void")(max_size);
}
void XLAType::_cufft_clear_plan_cache() const {
    return XLATypeDispatch::get_function<void (*)()>("_cufft_clear_plan_cache() -> void")();
}
...
Tensor XLAType::logspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const {
    return XLATypeDispatch::get_function<Tensor (*)(Scalar, Scalar, int64_t, const TensorOptions &)>("logspace(Scalar start, Scalar end, int64_t steps, TensorOptions options) -> Tensor")(start, end, steps, options);
}
Tensor & XLAType::logspace_out(Tensor & out, Scalar start, Scalar end, int64_t steps) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, Scalar, Scalar, int64_t)>("logspace_out(Tensor out, Scalar start, Scalar end, int64_t steps) -> Tensor")(out, start, end, steps);
}
...
Tensor XLAType::one_hot(const Tensor & self, int64_t num_classes) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t)>("one_hot(IndexTensor self, int64_t num_classes) -> Tensor")(self, num_classes);
}
...
std::tuple<Tensor,Tensor> XLAType::_unique_dim(const Tensor & self, int64_t dim, bool sorted, bool return_inverse) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, int64_t, bool, bool)>("_unique_dim(Tensor self, int64_t dim, bool sorted, bool return_inverse) -> std::tuple<Tensor,Tensor>")(self, dim, sorted, return_inverse);
}
...
Tensor XLAType::native_clone(const Tensor & self) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &)>("native_clone(Tensor self) -> Tensor")(self);
}
...
Tensor & XLAType::native_resize_as_(Tensor & self, const Tensor & the_template) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &)>("native_resize_as_(Tensor self, Tensor the_template) -> Tensor")(self, the_template);
}
...
Tensor & XLAType::native_pow_out(Tensor & out, const Tensor & self, Scalar exponent) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, Scalar)>("native_pow_out(Tensor out, Tensor self, Scalar exponent) -> Tensor")(out, self, exponent);
}
Tensor XLAType::native_pow(const Tensor & self, Scalar exponent) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, Scalar)>("native_pow(Tensor self, Scalar exponent) -> Tensor")(self, exponent);
}
...
Tensor & XLAType::native_zero_(Tensor & self) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &)>("native_zero_(Tensor self) -> Tensor")(self);
}
...
Tensor & XLAType::cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, int64_t)>("cross_out(Tensor out, Tensor self, Tensor other, int64_t dim) -> Tensor")(out, self, other, dim);
}
Tensor XLAType::cross(const Tensor & self, const Tensor & other, int64_t dim) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, int64_t)>("cross(Tensor self, Tensor other, int64_t dim) -> Tensor")(self, other, dim);
}
...
Tensor & XLAType::gather_out(Tensor & out, const Tensor & self, int64_t dim, const Tensor & index) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, int64_t, const Tensor &)>("gather_out(Tensor out, Tensor self, int64_t dim, Tensor index) -> Tensor")(out, self, dim, index);
}
Tensor XLAType::gather(const Tensor & self, int64_t dim, const Tensor & index) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, int64_t, const Tensor &)>("gather(Tensor self, int64_t dim, Tensor index) -> Tensor")(self, dim, index);
}
...
std::tuple<Tensor &,Tensor &> XLAType::trtrs_out(Tensor & X, Tensor & M, const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, const Tensor &, bool, bool, bool)>("trtrs_out(Tensor X, Tensor M, Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor &,Tensor &>")(X, M, self, A, upper, transpose, unitriangular);
}
std::tuple<Tensor,Tensor> XLAType::trtrs(const Tensor & self, const Tensor & A, bool upper, bool transpose, bool unitriangular) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, const Tensor &, bool, bool, bool)>("trtrs(Tensor self, Tensor A, bool upper, bool transpose, bool unitriangular) -> std::tuple<Tensor,Tensor>")(self, A, upper, transpose, unitriangular);
}
...
Tensor & XLAType::potri_out(Tensor & out, const Tensor & self, bool upper) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, bool)>("potri_out(Tensor out, Tensor self, bool upper) -> Tensor")(out, self, upper);
}
Tensor XLAType::potri(const Tensor & self, bool upper) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, bool)>("potri(Tensor self, bool upper) -> Tensor")(self, upper);
}
...
std::tuple<Tensor &,Tensor &> XLAType::btrifact_out(Tensor & A_LU, Tensor & pivots, const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, bool)>("btrifact_out(Tensor A_LU, Tensor pivots, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &>")(A_LU, pivots, self, pivot);
}
std::tuple<Tensor,Tensor> XLAType::btrifact(const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor> (*)(const Tensor &, bool)>("btrifact(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor>")(self, pivot);
}
std::tuple<Tensor &,Tensor &,Tensor &> XLAType::btrifact_with_info_out(Tensor & A_LU, Tensor & pivots, Tensor & info, const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &,Tensor &> (*)(Tensor &, Tensor &, Tensor &, const Tensor &, bool)>("btrifact_with_info_out(Tensor A_LU, Tensor pivots, Tensor info, Tensor self, bool pivot) -> std::tuple<Tensor &,Tensor &,Tensor &>")(A_LU, pivots, info, self, pivot);
}
std::tuple<Tensor,Tensor,Tensor> XLAType::btrifact_with_info(const Tensor & self, bool pivot) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor,Tensor,Tensor> (*)(const Tensor &, bool)>("btrifact_with_info(Tensor self, bool pivot) -> std::tuple<Tensor,Tensor,Tensor>")(self, pivot);
}
Tensor & XLAType::btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
    return XLATypeDispatch::get_function<Tensor & (*)(Tensor &, const Tensor &, const Tensor &, const Tensor &)>("btrisolve_out(Tensor out, Tensor self, Tensor LU_data, Tensor LU_pivots) -> Tensor")(out, self, LU_data, LU_pivots);
}
Tensor XLAType::btrisolve(const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
    return XLATypeDispatch::get_function<Tensor (*)(const Tensor &, const Tensor &, const Tensor &)>("btrisolve(Tensor self, Tensor LU_data, Tensor LU_pivots) -> Tensor")(self, LU_data, LU_pivots);
}
...
std::tuple<Tensor &,Tensor &> XLAType::adaptive_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("adaptive_max_pool2d_out(Tensor output, Tensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
...
std::tuple<Tensor &,Tensor &> XLAType::adaptive_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    return XLATypeDispatch::get_function<std::tuple<Tensor &,Tensor &> (*)(Tensor &, Tensor &, const Tensor &, IntArrayRef)>("adaptive_max_pool3d_out(Tensor output, Tensor indices, Tensor self, IntArrayRef output_size) -> std::tuple<Tensor &,Tensor &>")(output, indices, self, output_size);
}
