...
Tensor & TypeDefault::_th_masked_fill_bool_(Tensor & self, const Tensor & mask, Scalar value) const {
    AT_ERROR("_th_masked_fill_bool_ is not implemented for type ", toString());
}
Tensor & TypeDefault::_th_masked_fill_bool_(Tensor & self, const Tensor & mask, const Tensor & value) const {
    AT_ERROR("_th_masked_fill_bool_ is not implemented for type ", toString());
}
...
Tensor & TypeDefault::_th_masked_scatter_bool_(Tensor & self, const Tensor & mask, const Tensor & source) const {
    AT_ERROR("_th_masked_scatter_bool_ is not implemented for type ", toString());
}
...
Tensor & TypeDefault::_th_masked_select_bool_out(Tensor & result, const Tensor & self, const Tensor & mask) const {
    AT_ERROR("_th_masked_select_bool_out is not implemented for type ", toString());
}
Tensor TypeDefault::_th_masked_select_bool(const Tensor & self, const Tensor & mask) const {
    AT_ERROR("_th_masked_select_bool is not implemented for type ", toString());
}
...
Tensor & TypeDefault::uniform_(Tensor & self, double from, double to, Generator * generator) const {
    AT_ERROR("uniform_ is not implemented for type ", toString());
}
...
Tensor TypeDefault::mkldnn_adaptive_avg_pool2d(const Tensor & self, IntArrayRef output_size) const {
