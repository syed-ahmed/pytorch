...
std::tuple<Tensor &,Tensor &> TypeDefault::_thnn_adaptive_max_pool2d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    AT_ERROR("_thnn_adaptive_max_pool2d_forward_out is not implemented for type ", toString());
}
std::tuple<Tensor,Tensor> TypeDefault::_thnn_adaptive_max_pool2d_forward(const Tensor & self, IntArrayRef output_size) const {
...
std::tuple<Tensor &,Tensor &> TypeDefault::_thnn_adaptive_max_pool3d_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    AT_ERROR("_thnn_adaptive_max_pool3d_forward_out is not implemented for type ", toString());
}
std::tuple<Tensor,Tensor> TypeDefault::_thnn_adaptive_max_pool3d_forward(const Tensor & self, IntArrayRef output_size) const {
...
Tensor TypeDefault::logspace(Scalar start, Scalar end, int64_t steps, const TensorOptions & options) const {
    const DeviceGuard device_guard(options.device());
    return at::native::logspace(/* native_actuals */ start, end, steps, options);
}
Tensor & TypeDefault::logspace_out(Tensor & out, Scalar start, Scalar end, int64_t steps) const {
...
Tensor & TypeDefault::native_pow_out(Tensor & out, const Tensor & self, Scalar exponent) const {
...
Tensor & TypeDefault::cross_out(Tensor & out, const Tensor & self, const Tensor & other, int64_t dim) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
Tensor & TypeDefault::gather_out(Tensor & out, const Tensor & self, int64_t dim, const Tensor & index) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::gather_out(/* native_actuals */ out, self, dim, index);
}
...
Tensor & TypeDefault::potri_out(Tensor & out, const Tensor & self, bool upper) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::potri_out(/* native_actuals */ out, self, upper);
}
...
Tensor & TypeDefault::btrisolve_out(Tensor & out, const Tensor & self, const Tensor & LU_data, const Tensor & LU_pivots) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::btrisolve_out(/* native_actuals */ out, self, LU_data, LU_pivots);
}
...
Tensor & TypeDefault::frac_out(Tensor & out, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::frac_out(/* native_actuals */ out, self);
}
...
Tensor & TypeDefault::reciprocal_out(Tensor & out, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::reciprocal_out(/* native_actuals */ out, self);
}
...
Tensor & TypeDefault::neg_out(Tensor & out, const Tensor & self) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::neg_out(/* native_actuals */ out, self);
}
...
Tensor & TypeDefault::lerp_out(Tensor & out, const Tensor & self, const Tensor & end, Scalar weight) const {
    const OptionalDeviceGuard device_guard(device_of(self));
    return at::native::lerp_out(/* native_actuals */ out, self, end, weight);
}
...
std::tuple<Tensor &,Tensor &> TypeDefault::adaptive_max_pool2d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    const OptionalDeviceGuard device_guard(device_of(self));
...
std::tuple<Tensor &,Tensor &> TypeDefault::adaptive_max_pool3d_out(Tensor & output, Tensor & indices, const Tensor & self, IntArrayRef output_size) const {
    const OptionalDeviceGuard device_guard(device_of(self));
