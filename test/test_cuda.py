...
class TestMemPool(TestCase):
    ...
    def test_mempool_with_allocator(self):
        ...
        extern "C" {
          ...
          C10_EXPORT void dummy_free(void* ptr) { ptr = (void*)321; }
        }
        """
        ...
        pool.empty_cache()
        # out_0.data_ptr() and out_1.data_ptr() should be 321 if dummy_free
        # was used to deallocate them when empty_cache() was called
        self.assertEqual(out_0.data_ptr(), 321)
        self.assertEqual(out_1.data_ptr(), 321)
