...
std::tuple<Tensor,Tensor> VariableType::_gesv_helper(const Tensor & self, const Tensor & A) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_gesv_helper(self_, A_);
  })();
...
std::tuple<Tensor,Tensor> VariableType::_th_btrifact(const Tensor & self, bool pivot) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_btrifact(self_, pivot);
  })();
  std::tie(result, pivots) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
    AT_ASSERT(self__storage_saved.value().is_alias_of(self_.storage()));
  if (self__impl_saved) AT_ASSERT(self__impl_saved == self_.getIntrusivePtr());
...
Tensor VariableType::_th_median(const Tensor & self) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_median(self_);
  })();
  auto out = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
std::tuple<Tensor,Tensor> VariableType::_th_median(const Tensor & self, int64_t dim, bool keepdim) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->_th_median(self_, dim, keepdim);
  })();
...
std::tuple<Tensor,Tensor> VariableType::btrifact(const Tensor & self, bool pivot) const {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return baseType->btrifact(self_, pivot);
  })();
  std::tie(result0, result1) = as_variable(tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value())
...
Tensor & VariableType::thnn_conv2d_out(Tensor & output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding) const {
...
Tensor & VariableType::thnn_conv_depthwise2d_forward_out(Tensor & output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation) const {
